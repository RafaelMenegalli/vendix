    ...
    return (
        <div className={styles.mainContainer}>
            <div className={styles.actionBar}>
                <Button appearance='primary' color='violet'>Gerar Relatório</Button>
                <Button appearance='primary' color='yellow'>Função 2</Button>
                <Button appearance='primary' color='cyan'>Função 3</Button>
            </div>
